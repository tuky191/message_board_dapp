      ...
      return (
        <React.Fragment key={idx}>
          <div id={'myGroup' + thread_id}>
            <div
              className={
                'inner-main-body p-2 p-sm-3 collapse forum-content' +
                thread_id +
                ' show'
              }
              data-parent={'myGroup' + thread_id}
            >
              <ThreadTitle
                {...thread.related_messages[0]}
                time={newTime}
                thread_id={thread_id}
              />
            </div>
            <div
              className={
                'inner-main-body p-2 p-sm-3 collapse forum-content' + thread_id
              }
            >
              <Button
              ...
              <button
                ...
                onClick={() => activateMessageDialog(thread_id)}
              >
                <svg
            ...
            <div className='inner-wrapper'>
              <div className='inner-sidebar'>
                <div className='inner-sidebar-header justify-content-center'>
                  <button
                    className='btn btn-primary has-icon btn-block btn-discussion'
                    type='button'
                    data-toggle='modal'
                    data-target='#threadModal'
                    onClick={() => activateMessageDialog(null)}
                  >
                    <svg
                      xmlns='http://www.w3.org/2000/svg'
                      width='24'
              ...
              <div className='inner-main'>
                <div className='inner-main-header'>
                  <a href='/#' onClick={() => showModalSettings()}>
                    <img
                      src={userProfile.avatar}
                      className='mr-3 rounded-circle'
                      width='50'
